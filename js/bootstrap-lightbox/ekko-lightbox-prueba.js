  ...
  EkkoLightbox.prototype = {
    ...
    preloadImage: function(src, onLoadShowImage) {
      var img,
        _this = this;
      img = new Image();
      if ((onLoadShowImage == null) || onLoadShowImage === true || onLoadShowImage === false) {
        img.onload = function() {
          var image;
          image = $('<img />');
          ...
          if (img.width>img.height){
            ...
            return _this.resize_h(img.height);
          }
        };
    ...
    resize_h: function(height){
      var height_total;
      height_total = height + this.border.top + this.padding.top + this.padding.bottom + this.border.bottom;
      this.modal_dialog.css('height', 'auto').css('max-height', height_total);
